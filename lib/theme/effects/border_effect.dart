...
/// Border tokens for the Donj design system.
///
/// These tokens define the color, width, and directional distribution of borders
/// used for cards, inputs, and dividers. The constants are split into
/// "subtle" (Gray 20) and "strong" (Gray 50) for light themes, and a unified
/// "strong" (Gray 10) for dark themes based on the provided table.
class AppBorders {
  const AppBorders._();
  ...
  // 3. Helper to build borders dynamically
  /// Allows dynamic border construction matching the exact table values.
  /// Example: AppBorders.create(top: true, right: false, bottom: true, left: false)
  ...
  // Note: The table lists "$border-strong-01(Gray 10)" as the unified border for dark themes.
